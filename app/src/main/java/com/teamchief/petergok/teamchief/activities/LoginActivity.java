...
/**
 * A attemptLogin screen that offers attemptLogin via email/password and via Google+ sign in.
 * <p/>
...
public class LoginActivity extends PlusBaseActivity implements LoaderCallbacks<Cursor> {
    ...
    //Custom Fonts
    TextView mTitleView, mSloganView;
    EditText mUsernameHint, mPasswordHint;
    Button mForgottenPasswordPrompt;
    ...
    private ImageButton mPlusSignInButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get Lato Fonts
        latoBlackTypeFace=Typeface.createFromAsset(getAssets(),"fonts/lato-black.ttf");
        regularLatoTypeFace=Typeface.createFromAsset(getAssets(),"fonts/lato-regular.ttf");

        //Get Text fields requiring font changes
        mTitleView =(TextView)findViewById(R.id.team_chief_title);
        mSloganView =(TextView)findViewById(R.id.slogan_text);
        mUsernameHint = (AutoCompleteTextView) findViewById(R.id.username);
        mPasswordHint = (EditText) findViewById(R.id.password);
        mForgottenPasswordPrompt = (Button) findViewById(R.id.forgot_password_button);

        //Set Fonts
        mTitleView.setTypeface(latoBlackTypeFace);
        mSloganView.setTypeface(regularLatoTypeFace);
        mUsernameHint.setTypeface(regularLatoTypeFace);
        mPasswordHint.setTypeface(regularLatoTypeFace);
        mForgottenPasswordPrompt.setTypeface(regularLatoTypeFace);

        ////////////// KEVIN's non-GOOGLE PLUS LOGIN STUFF END/////////////////
        ...
        if (supportsGooglePlayServices()) {
            ...
            mPlusSignInButton.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    //signIn();
                    Toast.makeText(getApplicationContext(), "Feature Coming Soon",
    ...
    /**
     * Attempts to sign in or register the account specified by the attemptLogin form.
    ...
    public void attemptLogin() {
        ...
        if (cancel) {
            // There was an error; don't attempt attemptLogin and focus the first
    ...
    /**
     * Shows the progress UI and hides the attemptLogin form.
     */
